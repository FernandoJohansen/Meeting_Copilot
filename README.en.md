...
using a language model, cloud-based (OpenAI) or fully local (Ollama), with
transparent disclosure to meeting participants.
...
4. **Limit CPU threads.** By default (`0`) transcription uses all
   ...
   Lowering it to 1 or 2 threads leaves cores free for the rest of the
